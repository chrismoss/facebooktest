 ...
 *
 * @method static AdCampaignActivityChangedAnyValues getInstance()
 */
class AdCampaignActivityChangedAnyValues extends AbstractEnum {

  const AUTO_CREATE_LOOKALIKE = 'AUTO_CREATE_LOOKALIKE';
  const BID_ADJUSTMENTS_SPEC = 'BID_ADJUSTMENTS_SPEC';
