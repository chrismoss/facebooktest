...
class BusinessObject extends AbstractCrudObject {
  ...
  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['Type'] = BusinessObjectTypeValues::getInstance()->getValues();
    $ref_enums['AssetType'] = BusinessObjectAssetTypeValues::getInstance()->getValues();
    $ref_enums['Types'] = BusinessObjectTypesValues::getInstance()->getValues();
    return $ref_enums;
  }
