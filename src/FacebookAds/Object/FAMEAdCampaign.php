...
class FAMEAdCampaign extends AbstractCrudObject {
  ...
  protected static function getReferencedEnums() {
    $ref_enums = array();
    $ref_enums['DatePreset'] = FAMEAdCampaignDatePresetValues::getInstance()->getValues();
    $ref_enums['EffectiveStatus'] = FAMEAdCampaignEffectiveStatusValues::getInstance()->getValues();
    return $ref_enums;
  }
