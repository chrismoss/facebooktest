...
class AdCampaignActivity extends AbstractCrudObject {
  ...
  protected static function getReferencedEnums() {
    ...
    $ref_enums['ChangedAll'] = AdCampaignActivityChangedAllValues::getInstance()->getValues();
    $ref_enums['ChangedAny'] = AdCampaignActivityChangedAnyValues::getInstance()->getValues();
    return $ref_enums;
  }
