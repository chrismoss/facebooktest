...
use FacebookAds\Object\Values\ProductItemInsightsInsightsSourcesValues;
...
class ProductItem extends AbstractCrudObject {
  ...
  protected static function getReferencedEnums() {
    ...
    $ref_enums['OrderBy'] = ProductItemOrderByValues::getInstance()->getValues();
    return $ref_enums;
  }
  ...
  public function getInsights(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $param_types = array(
      'insights_sources' => 'list<insights_sources_enum>',
    );
    $enums = array(
      'insights_sources_enum' => ProductItemInsightsInsightsSourcesValues::getInstance()->getValues(),
    );
