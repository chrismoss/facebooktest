...
class AdCampaignGroupActivity extends AbstractCrudObject {
  ...
  protected static function getReferencedEnums() {
    ...
    $ref_enums['ChangedAll'] = AdCampaignGroupActivityChangedAllValues::getInstance()->getValues();
    $ref_enums['ChangedAny'] = AdCampaignGroupActivityChangedAnyValues::getInstance()->getValues();
    return $ref_enums;
  }
