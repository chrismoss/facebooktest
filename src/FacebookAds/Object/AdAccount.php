...
use FacebookAds\Object\Values\AdAccountActivityChangedAllValues;
use FacebookAds\Object\Values\AdAccountActivityChangedAnyValues;
...
use FacebookAds\Object\Values\AdKpiShiftEventSourceValues;
...
use FacebookAds\Object\Values\AudienceStudyStudyStatusValues;
...
use FacebookAds\Object\Values\CustomAudienceStudyStatusValues;
...
use FacebookAds\Object\Values\FAMEAdCampaignGroupDatePresetValues;
use FacebookAds\Object\Values\FAMEAdCampaignGroupEffectiveStatusValues;
...
use FacebookAds\Object\Values\ReportStatsMetadataActionsGroupByValues;
use FacebookAds\Object\Values\ReportStatsMetadataDatePresetValues;
use FacebookAds\Object\Values\TopicDiscoveryResponseQueryMethodValues;
use FacebookAds\Object\Values\UniqueAdCreativeDatePresetValues;
...
class AdAccount extends AbstractCrudObject {
  ...
  public function getActivityLogs(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $enums = array(
      'changed_all_enum' => AdAccountActivityChangedAllValues::getInstance()->getValues(),
      'changed_any_enum' => AdAccountActivityChangedAnyValues::getInstance()->getValues(),
    );
  ...
  public function getAdColumnSizes(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdReportBuilderReports(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdCampaignConversions(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdCampaignStats(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdGroupConversions(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdGroupStats(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdReportSpecs(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdScriptExecutionHistories(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdScripts(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAdsPaymentCycle(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAsyncSessions(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAudienceInsightsStudyRules(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getAudienceStudies(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $enums = array(
      'study_status_enum' => AudienceStudyStudyStatusValues::getInstance()->getValues(),
    );
  ...
  public function getAudienceOverlap(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

    $param_types = array(
      'pivot_id' => 'unsigned int',
      'comparison_ids' => 'list<unsigned int>',
  ...
  public function getAudienceSharingAccountValid(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

    $param_types = array(
      'recipient_adaccount' => 'string',
    );
    $enums = array(
    );
  ...
  public function getAudienceSharingRecipientAccounts(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getBrandLiftStudies(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getBrazilCreditMemos(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getBusinessAdAccountRequests(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getCheckoutPayments(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getCurrentAdDrafts(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getDeliveryInsightsActivities(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $param_types = array(
      ...
      'uid' => 'int',
      'business_id' => 'string',
      'ad_set_ids' => 'list<string>',
      'add_children' => 'bool',
      'activity_type' => 'activity_type_enum',
    );
    $enums = array(
      'category_enum' => AdActivityCategoryValues::getInstance()->getValues(),
      'activity_type_enum' => AdActivityActivityTypeValues::getInstance()->getValues(),
    );
  ...
  public function getEmailImport(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getEngagementInsightsRules(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

    $param_types = array(
      'rule_ids' => 'list<unsigned int>',
    );
    $enums = array(
    );
  ...
  public function getExportAds(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getExportAdSets(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getExportCampaigns(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getFameCampaigns(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $enums = array(
      'date_preset_enum' => FAMEAdCampaignGroupDatePresetValues::getInstance()->getValues(),
      'effective_status_enum' => FAMEAdCampaignGroupEffectiveStatusValues::getInstance()->getValues(),
    );
  ...
  public function getKpiShifts(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $enums = array(
      'event_source_enum' => AdKpiShiftEventSourceValues::getInstance()->getValues(),
    );
  ...
  public function getNotaFiscals(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getPaymentDetailsList(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

    $param_types = array(
      'payment_ids' => 'list<string>',
      'payment_status' => 'string',
      'should_filter_by_due_date_cc_id' => 'bool',
    );
    $enums = array(
    );
  ...
  public function getPlacementUsage(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getReporting(array $fields = array(), array $params = array(), $pending = false) {
    ...
    $param_types = array(
      ...
      'dimension_groups' => 'list<list<adaccountreporting_dimension_groups_enum_param>>',
  ...
  public function getReportStatsMetadata(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $enums = array(
      'actions_group_by_enum' => ReportStatsMetadataActionsGroupByValues::getInstance()->getValues(),
      'date_preset_enum' => ReportStatsMetadataDatePresetValues::getInstance()->getValues(),
    );
  ...
  public function getSpendLimits(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getStudyAudiences(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $enums = array(
      'study_status_enum' => CustomAudienceStudyStatusValues::getInstance()->getValues(),
    );
  ...
  public function getTargetingSearchRecommendation(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getTargetingSearchReplaceMEnts(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getTopicDiscoveryResponses(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

    $param_types = array(
      'query_terms' => 'list<string>',
      'limit' => 'int',
      'query_method' => 'query_method_enum',
      'language' => 'Object',
    );
    $enums = array(
      'query_method_enum' => TopicDiscoveryResponseQueryMethodValues::getInstance()->getValues(),
    );
  ...
  public function getTransactionDetails(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();

    $param_types = array(
      'transaction_keys' => 'list<string>',
    );
    $enums = array(
    );
  ...
  public function getUniqueAdCreatives(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
    ...
    $enums = array(
      'date_preset_enum' => UniqueAdCreativeDatePresetValues::getInstance()->getValues(),
    );
