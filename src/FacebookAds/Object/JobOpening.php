...
class JobOpening extends AbstractCrudObject {
  ...
  public function getCustomQuestions(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getJobApplications(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
