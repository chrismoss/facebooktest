...
class InstagramUser extends AbstractCrudObject {
  ...
  public function getInstagramMedia(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
  ...
  public function getMobileInsights(array $fields = array(), array $params = array(), $pending = false) {
    $this->assureId();
